...
Concessions::Concessions(string iname, string idecsription, double lprice, double mprice, double sprice, int num1, int num2, int num3) : Item(iname, idecsription)
{
...
void Concessions::printdetail(){
	cout << "Large Price: \" $";
	cout << Getlprice() << "\" Medium Price: \" $" << Getmprice() << "\" Small Price: \" $" << Getsprice() << "\" \nLarge Number: \" ";
	cout << Getnum1() << "\" Medium Number: \" " << Getnum2() << "\" Small Number: \" " << Getnum3() << "\" " << endl;
}